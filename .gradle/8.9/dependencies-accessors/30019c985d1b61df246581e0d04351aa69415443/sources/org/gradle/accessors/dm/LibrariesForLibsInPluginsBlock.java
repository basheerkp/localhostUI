...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final KhushpanchalLibraryAccessors laccForKhushpanchalLibraryAccessors = new KhushpanchalLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>khushpanchal</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public KhushpanchalLibraryAccessors getKhushpanchal() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForKhushpanchalLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class KhushpanchalLibraryAccessors extends SubDependencyFactory {

        public KhushpanchalLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ketch</b> with <b>com.github.khushpanchal:Ketch</b> coordinates and
         * with version reference <b>ketchVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getKetch() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("khushpanchal.ketch");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ketchVersion</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKetchVersion() { return getVersion("ketchVersion"); }
